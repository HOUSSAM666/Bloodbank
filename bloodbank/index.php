...
<body>
   ...
   <?php require 'message.php'; ?>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <i class="fa fa-mobile"> </i> <a > +212611223344</a><br><br>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="row mb-5">
            <div class="col-lg-12">
            <div class="card">
                <div class="card-header">Some Health tips</div>
                <div class="card-body">
                    ...
                    Take care of yourself please , visit here to get more health tips.
                    <a href="https://www.sante.gov.ma/Pages/Accueil.aspx" target="_blank"> Moroccan Health Minister WebSite</a>
                </div>
            </div>
            </div>
        </div>
